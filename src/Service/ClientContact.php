 ...
 *
 * @see \LBM\Action\ClientContact
 * @method static array all(array $where = [], string $direction = 'ASC', ?string $order = null)
 * @method static bool allows(array $contact, string $access)
 ...
 * @method static array forClient(int $clientId)
 * @method static ?array forClientKey(int|string $key, int $clientId)
 * @method static array groups()
 * @method static void makePrimary(int $contactId, int $clientId)
 * @method static Model model()
 * @method static int modify(int|string $key, array $input)
 * @method static void setPassword(int $contactId, string $password)
 * @method static int store(int $clientId, array $input, ?string $password = null)
