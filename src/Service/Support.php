 ...
 * @method static ?int defaultDepartmentId()
 ...
 * @method static int openByClient(array $input, string $message, ?int $clientId)
 * @method static int openByStaff(array $input, string $message, ?int $staffId)
 ...
 * @method static int replyByClient(int $ticketId, string $message, ?int $clientId)
 * @method static int replyByStaff(int $ticketId, string $message, ?int $staffId, bool $internal = false)
