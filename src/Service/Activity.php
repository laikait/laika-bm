 ...
 * @method static array forStaff(int $staffId, ?int $limit = null)
 ...
 * @method static bool recordClient(string $event, string $log, ?int $clientId, array $changes = [])
 * @method static bool recordContact(string $event, string $log, ?int $contactId, array $changes = [])
 * @method static bool recordStaff(string $event, string $log, ?int $staffId, array $changes = [])
